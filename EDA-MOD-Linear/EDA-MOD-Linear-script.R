...
# The slope and the y-intercept are our parameters.
# The slope is also knwon as the regression coefficient which is calculated
# by taking two points of the line. It describes the rate of change of one
# variable y as a function of variable x.
# The y-intercept tells us where the line is in our model.
